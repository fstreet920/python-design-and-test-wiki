...
Using a simple class for Memento and Originator.
...
class ConcreteMemento:
    ...
    def get_name(self) -> str:
        """The Caretaker uses this method to display metadata."""
...
class Originator:
    ...
    def do_something(self) -> None:
        """The Originator's business logic may affect its internal state. Therefore, the client should backup the state before launching methods of the business logic via the save() method."""
...
if __name__ == "__main__":
    originator = Originator("Super-duper-super-puper-awesome.")
...
- [Memento_Harness](../testing/Memento_Harness.md)
